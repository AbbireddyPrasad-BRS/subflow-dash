      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            {/* Billing Toggle */}
            <div className="inline-flex items-center bg-glass/50 backdrop-blur-xl border border-glass-border rounded-lg p-1">
              <button
          ...
          <div className="mt-20 text-center">
            <div className="glass-elevated p-12 rounded-2xl max-w-3xl mx-auto">
